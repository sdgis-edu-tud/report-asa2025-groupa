...
![Composition of MCDA](image/MCDAcomp.svg) **Biodiversity**
...
::: {layout-ncol="2"}
![Biodiversityunit\|unit with highes value: ID 20](image/B_highest3.png){width="480"} ![Biodiversityunit\|unit with highes value: ID 54](image/B_highest2.png){width="480"}
:::
...
::: {layout-ncol="2"}
![Biodiversityunit\|units with 0 value](image/Q_lowest_1.png){width="480"} ![Biodiversityunit\|units with 0 value](image/Q_lowest_2.png){width="480"}
:::
...
::: {layout-ncol="2"}
![Climate Adaptation\|unit with lowe value (ID 13)](image/C_lowest1.png){width="480"} ![Climate Adaptation\|units with low value (ID 17, 20)](image/C_lowest2.png){width="480"}
:::
...
![Quintiles of the final MCDA score](image/mcda_quintiles.jpg){width="960"}
...
The clustering yielded four distinct typologies based on the central values of three key criteria: 
(1)connectivity to green, (2)concentration of POI, and (3)impact of flood.
...
#### 3.2.2 Interpretation of clusters and 
...
| Type  | Recommendation                                            |
|-------|-----------------------------------------------------------|
| **1** | little improvement for flood adaptation suggested         |
| **2** | extend green space, add attraction points                 |
| **3** | urgent need for flood adaptiation improvement             |
| **4** | lots of potential for creating recreational natural space |
