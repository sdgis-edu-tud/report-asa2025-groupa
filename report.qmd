...
Most of the units have a green coverage percentage below 10%. Based on biophilic planning indicators, approximately 30 units fall below the recommended standard. However, some units that intersect with larger green areas show relatively higher values, though none exceed 30%.

::: {layout-ncol="2"}
![Biodiversity 1 - Percentage of green](image/percentage_1.png){width="480"}
...
![Biodiversity 2 - Connectivity to green](image/distance_2.png)

![Biodiversity 3 - Presence of species : Buffer of 2km](image/species-2.png)
