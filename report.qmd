...
![Figure 1. Objectives: Urban Stream Restoration](image/introduction_1.jpg)

#### 1.2 Human-nature connectedness and its relevance to urban stream restoration
...
#### 1.3 What is the effect of biodiversity on biophilic integration?
...
#### 1.4 How can quality of life be enhanced through biophilic integration?
...
#### 1.5 How does microclimate affect biophilic integration?
...
![Figure 4. Criteria Overview](image/MCDA_table.png)
...
::: {layout-ncol="3"}
![Figure 6: Criteria Weighting](image/weighting_biodiversity.JPG){width="312"}
...
Elbow plot for this research is shown below: ![elbow plot](image/ElbowPlot.png)
...
**Percentage of Green** The distribution of green coverage among the stream units varies between 0% and 30%, indicating a relatively low to moderate presence of vegetation throughout the area.

::: {layout-ncol="2"}
![Biodiversity 1 - Percentage of green: buffer of 500m](image/percentage_1.png){width="480"}

![Biodiversity 1 - Percentage of green: normalised](image/percentage_2.png){width="480"}
:::
...
::: {layout-ncol="2"}
![Biodiversity 2 - Connectivity to green: distant to closest green](image/distance_1.png){width="480"}

![Biodiversity 2 - Connectivity to green: normalised](image/distance_2.png){width="480"}
:::
...
::: {layout-ncol="2"}
![Biodiversity 3 - Presence of species : buffer of 2km](image/species-1.png){width="480"}

![Biodiversity 3 - Presence of species : normalised](image/species-2.png){width="480"}
:::
...
![Biodiversity 3 - stream units with lowest score](image/species_lowestpart.png){width="960"}
...
![Biodiversity 3 - street view of lowest unit](image/species_powerline.png){width="960"}
...
::: {layout-ncol="2"}
![Quality of Life 2 - Proximity to Activities: buffer of 1km](image/Activities_1.png){width="480"}

![Quality of Life 2 - Proximity to Activities normalised](image/Activities_2.png){width="480"}
:::
...
::: {layout-ncol="2"}
![Quality of Life 3 - Concetration of POI: buffer of 200m](image/POI_1.png){width="480"}

![Quality of Life 3 - Concetration of POI: normalised](image/POI_2.png){width="480"}
:::
...
::: {layout-ncol="2"}
![Quality of Life 2 - Proximity to Activities: buffer of 500m + normalised (zoomed in)](image/POI_compare_1.png){width="480"}

![Quality of Life 3 - Concetration of POI: buffer of 200m + normalised (zoomed in)](image/POI_compare_2.png){width="480"}
:::
...
::: {layout-ncol="2"}
![Climate Adaptation 1 \| Permeability: buffer of 200m](image/Permeabilty_1.png){width="480"}

![Climate Adaptation 1 \| Permeability: normalised](image/Permeabilty_2.png){width="480"}
:::
...
![Climate Adaptation 2 \|Impact of Flooding: buffer of 500m](image\flood_impact.svg){width="960"}

The stream unit intersecting the residential area near Jána Mudrocha Street (ID 13) recorded the lowest normalized score, due to a high number of small-sized buildings located within the floodplain.
While each individual building may be small, their cumulative presence suggests a higher concentration of people or property at risk, making this zone especially vulnerable.

::: {layout-ncol="2"}
![Climate Adaptation 2 \| Stream unit with highest score (ID 13)](image/impactofflood_highest.png){width="480"}

![Climate Adaptation 2 \| Other units for comparison ](image/impactofflood_compare.png){width="480"}
:::
...
![Climate Adaptation 3 \|Impact of Flooding: Buffer 500m](image\temperature.svg){width="960"}
...
![Climate Adaptation 2 \| stream unit with lowest score](image/temperature_lowest.png){width="960"}
...
![Climate Adaptation 1 \| street view of lowest unit](image/temperature_street.png){width="960"}
...
![Biodiversityunit\|unit with highest value: ID 5](image/B_highest1.png){width="960"}
...
::: {layout-ncol="2"}
![Biodiversityunit\|unit with highes value: ID 20](image/B_highest3.png){width="480"}
![Biodiversityunit\|unit with highes value: ID 54](image/B_highest2.png){width="480"}
:::


**Quality of Life**

The Quality of Life category demonstrates a clear urban–peripheral gradient, with higher scores concentrated in the city center and markedly lower values toward the outer stream segments.
This trend reflects the distribution of civic amenities, built infrastructure, and accessible services, which are typically concentrated in urban cores.
...
![Biodiversityunit\|unit with highest value: ID 3](image/Q_highest.png){width="960"}
...
::: {layout-ncol="2"}
![Biodiversityunit\|units with 0 value](image/Q_lowest_1.png){width="480"}
![Biodiversityunit\|units with 0 value](image/Q_lowest_2.png){width="480"}
:::
...
::: {layout-ncol="2"}
![Climate Adaptation\|unit with lowe value (ID 13)](image/C_lowest1.png){width="480"}
![Climate Adaptation\|units with low value (ID 17, 20)](image/C_lowest2.png){width="480"}
:::
