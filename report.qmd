...
![Objectives: Urban Stream Restoration](image/introduction_1.jpg)
...
![MCDA hierarchy tree](image/mcda_tree.jpg)
...
::: {layout-ncol="3"}
![Criteria Weighting](image/weighting_biodiversity.JPG){width="312"}
...
::: {layout-ncol="2"}
![Biodiversityunit\|unit with highes value: ID 20](image/B_highest3.png)

![Biodiversityunit\|unit with highes value: ID 54](image/B_highest2.png)
:::
...
::: {layout-ncol="2"}
![Biodiversityunit\|units with 0 value](image/Q_lowest_1.png)
![Biodiversityunit\|units with 0 value](image/Q_lowest_2.png)
:::
...
::: {layout-ncol="2"}
![Climate Adaptation\|unit with lowe value (ID 13)](image/C_lowest1.png)
![Climate Adaptation\|units with low value (ID 17, 20)](image/C_lowest2.png)
:::
...
![Comparison - MCDA and Typology construction result maps](image/Combined.png)
