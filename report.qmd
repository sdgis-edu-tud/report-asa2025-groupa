...
| Cluster | Connectivity to green | rank | Concentration of POI | rank | Impact of Flood | rank |
|-----------|-------------|-------|-------------|-------|-------------|-------|
...
| Cluster | Connectivitity to green | Concentration of POI | Impact of Flood | Recommendation |
|-------------|-------------|-------------|-------------|-------------------|
