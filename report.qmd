...
According to Biophilic Planning Indicators, a minimum of 10% of each area should be covered by trees or vegetation (source: XXXX).In the case of Teplica, only 9 out of 54 units exceed this standard. The units with more than 10% green coverage are generally those that intersect with larger green spaces, such as gardens (Zahrádková osada Kunov), parks (Městský park), or unused open green areas.
