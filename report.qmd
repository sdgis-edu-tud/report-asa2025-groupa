...
The highest scoring units are located around Námestie Oslobodenia, a key urban road corridor. The stream unit intersecting this road recorded the maximum proximity value, suggesting a strong spatial integration between the stream and surrounding civic or commercial infrastructure in that zone.
...
Notably, the stream unit intersecting with Námestie Oslobodenia, which previously scored highest in 'Proximity to Activity' and 'Concentration of POI', now records the lowest permeability score.This contrast highlights a critical trade-off: areas with high human activity lacks climate resilience.
...
The stream unit intersecting the residential area near Jána Mudrocha Street recorded the lowest normalized score, due to a high number of small-sized buildings located within the floodplain.
...
::: {layout-ncol="2"}
![Climate Adaptation 2 \| Stream unit with highest score](image/impactofflood_highest.png){width="480"}
