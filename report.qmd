...
This green area value was then joined to the buffer layer, enabling the calculation of the green-to-total-area ratio for each unit. Since the green space percentages range approximately from 0% to 30%, the data was categorized into ten equal intervals, each representing a 3% range. A normalized value was also calculated using the formula.
...
![Quintiles of the final MCDA score](image/mcda%20quintiles.jpg)
...
**Biodiversity**/ ![Biodiversity 1 \| Percentage of green](image/percentage_1.png) ![Biodiversity 2 \| Connectivity to green](image/distance_1.png) ![Biodiversity 3 \| Presence of species : Buffer of 2km](image/species-1.png)

**Quality of Life**/ ![Quality of Life 1 \| Proximity to Greens Spaces](image/GreenAreas_1.png) ![Quality of Life 2 \| Proximity to Activites](image/Activities_1.png) ![Quality of Life 3 \| Concetration of POI](image/POI_1.png)

**Climate Adaptation**/ ![Climate Adaptation 1 \| Permeability of the ground](image/Permeabilty_1.png) ![Climate Adaptation 2 \|Impact of Flooding: Buffer 500m](image\flood_impact.svg) ![Climate Adaptation 3 \|Impact of Flooding: Buffer 500m](image\temperature.svg)
